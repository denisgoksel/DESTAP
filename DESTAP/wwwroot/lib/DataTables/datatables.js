 ...
 *   https://datatables.net/download/#bs4/dt-2.1.8/b-3.2.0/b-html5-3.2.0/b-print-3.2.0/r-3.0.3
 *
 * Included libraries:
 *   DataTables 2.1.8, Buttons 3.2.0, HTML5 export 3.2.0, Print view 3.2.0, Responsive 3.0.3
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "bs4/dt-2.1.8/b-3.2.0/b-html5-3.2.0/b-print-3.2.0/r-3.0.3",
